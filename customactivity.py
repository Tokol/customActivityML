...
st.markdown("""
This tool helps to create own activity, processes accelerometer data, extracts features, and compares 
...
if st.session_state.df is not None:
    ...
    # ==========================
    # ACTIVITY DEFINITION (CUSTOM ONLY)
    # ==========================
    ...
    if st.button("🔧 Process Data & Extract Features", type="primary", key="process_button"):
        with st.spinner("Processing data and extracting features..."):
            ...
            # Store time ranges for visualization (custom activities only)
    ...
    if st.session_state.features_df is not None:
        ...
        # Add activity regions to the plot (custom activities only)
        # Use the stored time_ranges format
        ...
        if not processed_activities:
            # Check if we have direct activity entries
        ...
        with col1:
            ...
            fig_cv.update_layout(
                ...
                xaxis=dict(showgrid=False, zeroline=False, showticklabels=False,
                           range=[-0.5, recommended_cv_folds * 0.8]),
                yaxis=dict(showgrid=False, zeroline=False, showticklabels=False,
                           range=[-0.5, recommended_cv_folds * 1.2]),
                height=300,
                plot_bgcolor='white',
                showlegend=False
            )
        ...
        **Your selection**: **{recommended_cv_folds}-fold CV** because {fold_reason.lower()}
        ...
        with hyper_tab1:
            ...
            **How we find optimal k:**
            ...
            base_acc = 0.85  # Higher base for easier classification
        ...
        with hyper_tab2:
            ...
            **How we optimize:**
            ...
            # Add training time line (scaled by number of CV folds) on secondary axis
            fig_tradeoff.add_trace(go.Scatter(
                x=n_estimators_range,
                y=training_times,
                mode='lines+markers',
            ...
            fig_tradeoff.update_layout(
                ...
                hovermode='x unified',
                yaxis=dict(
                    title=f"{recommended_cv_folds}-Fold CV Accuracy",
                    tickformat='.0%'
                ),
                yaxis2=dict(
            ...
            **Your dataset has:**
            ...
            - **Total 9 features**: Good representation of your custom activities
        ...
        with hyper_tab3:
            ...
            **Why {int(optimal_test_size * 100)}% Test Size is Recommended:**
            ...
            dataset_categories = ['Very Small (<50)', 'Small (50-100)', 'Medium (100-500)', 'Large (500-2000)',
                                  'Very Large (>2000)']
        ...
        **Algorithm Configuration:**
        ...
        if st.session_state.knn_results is not None and st.session_state.rf_results is not None:
            ...
            **📈 Key Insights:**
            ...
            # ==========================
            st.markdown("---")
            add_code_insights_section(activities_from_features)
